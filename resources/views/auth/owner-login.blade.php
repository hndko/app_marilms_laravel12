...
<head>
    ...
    <title>Login Owner — MariLMS</title>
...
<body>
    <div class="login-card">
        ...
        <div class="form-title">
            ...
            <p>Kelola soal kuis AI, peserta, dan saldo token Anda</p>
        </div>
        ...
        <form method="POST" action="{{ route('owner.login.submit') }}">
            ...
            <div class="form-group">
                ...
                <input type="email" name="email" class="form-input" value="{{ old('email', 'owner@marilms.com') }}" required autofocus placeholder="nama@organisasi.com">
            </div>
        ...
        <div class="footer-link">
            Belum punya akun tenant? <a href="{{ route('owner.register') }}">Daftar Sekarang</a>
        </div>
    </div>
</body>
</html>
