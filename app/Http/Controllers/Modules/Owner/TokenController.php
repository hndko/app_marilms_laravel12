...
class TokenController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('modules.owner.tokens.index', compact('tenant', 'owner', 'packages', 'gateways', 'transactions'));
    }
    ...
    public function simulatePayment(Request $request, $orderId)
    {
        ...
        return view('modules.owner.tokens.simulate', compact('tenant', 'order'));
    }
