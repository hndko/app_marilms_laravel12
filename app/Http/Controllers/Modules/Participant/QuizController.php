...
class QuizController extends Controller
{
    ...
    public function show($tenant, Quiz $quiz)
    {
        ...
        return view('modules.participant.quiz.show', compact('tenant', 'quiz', 'remainingAttempts', 'hasPassed', 'previousAttempts'));
    }
    ...
    public function takeQuiz($tenant, QuizAttempt $attempt)
    {
        ...
        return view('modules.participant.quiz.take', compact(
    ...
    public function showResult($tenant, QuizAttempt $attempt)
    {
        ...
        return view('modules.participant.quiz.result', compact(
    ...
    public function history($tenant)
    {
        ...
        return view('modules.participant.history', compact('tenant', 'attempts'));
    }
}
