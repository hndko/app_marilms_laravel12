...
class QuizController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('owner.quizzes.index', compact('tenant', 'quizzes', 'categories'));
    }
    ...
    public function create()
    {
        ...
        return view('owner.quizzes.create', compact('tenant', 'owner', 'tokenBalance', 'isUnlimited', 'tokenPerQuestion'));
    }
