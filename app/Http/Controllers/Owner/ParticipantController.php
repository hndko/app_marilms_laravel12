...
class ParticipantController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('owner.participants.index', compact('tenant', 'participants'));
    }
    ...
    {
        $tenant = $this->getTenant();
        return view('owner.participants.create', compact('tenant'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($request->boolean('send_invite')) {
            // Placeholder for Phase 8 Notification Service
    ...
    public function show($id)
    {
        ...
        return view('owner.participants.show', compact('tenant', 'participant'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('owner.participants.edit', compact('tenant', 'participant'));
    }
