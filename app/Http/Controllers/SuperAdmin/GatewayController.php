...
class GatewayController extends Controller
{
    public function index()
    {
        ...
        return view('superadmin.gateways.index', compact('paymentGateways', 'emailConfig', 'whatsappConfigs'));
    }
    ...
    {
        // Will be implemented when WA gateway drivers are ready (Phase 8)
